...
class DefaultController extends Controller {
    ...
    public function getInfoBuildingAction(Request $request) {
       ...
       // $a = $em->getConnection();
       // $a->createQuery("select * from Brigada inner join UsuarioBrigada on idBrigada = id_brigada inner join Usuario on id_usuario = idUsuario where id_inmueble = 2");
       // $a->prepare();
       // $a->execute();
        ...
        $data = array(
            ...
            'result2' => 'No hay Divisiones Academicas para este edificio',
            'result3' => 'No hay Academias para este edificio',
           // 'result4' => 'No personal asignado'
        );
